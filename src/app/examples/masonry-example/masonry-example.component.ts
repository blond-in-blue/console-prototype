...
export class MasonryExampleComponent implements OnInit {
  ...
  masonryItems = [
    ...
    { title: new ContentItem(BootstrapExampleComponent), width: Widths.large, height: Heights.large },
    { title: new ContentItem(BootstrapExampleComponent), width: Widths.large, height: Heights.medium },
    { title: new ContentItem(BootstrapExampleComponent), width: Widths.large, height: Heights.small },
